  ...
  <body>
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li>
          <form name="hf" action="<%=basePath %>newmsgservlet?order=shousuo" method="post" onsubmit="chh();">
          	...
          	<a href="<%=basePath %>newmsgservlet?order=list" class="button border-main icon-search"> 首 页 </a>
          </form>
      </ul>
    </div>
