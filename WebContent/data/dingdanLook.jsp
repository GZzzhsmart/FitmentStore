...
<div class="pre_box w">
	...
	<div id="JS_address_box__" class="currentBox">
		<div class="title clearfix"  style="height:60px;" style="background:#f0f0f0">
			<table width="100%" height="100%">
				<tr>
					<td width="100"><font size="5">订单号:</font></td>
					<td width="180"><font size="4" color="red">${dingdan.dingdannumber }</font></td>
					<td width="100"><font size="3">订单状态：</font></td>
					<c:if test="${dingdan.effective==1}">
						<td>待付款</td>
						<td align="right">
							<a href="<%=basePath %>dingdanservlet?order=paymoney&dingdanid=${dingdan.dingdanid }" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">立即支付</font></a>
							<a href="<%=basePath %>dingdanservlet?order=del&dingdanid=${dingdan.dingdanid }" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;" onclick="return confirm('是否取消订单');"><font color="white">取消订单</font></a>
						</td>
					</c:if>
					<c:if test="${dingdan.effective==2}">
						<td>待发货</td>
						<td align="right"><a href="javascript:void(0);" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">取消订单</font></a></td>
					</c:if>
					<c:if test="${dingdan.effective==3}">
						<td>待收货</td>
						<td align="right"><a href="<%=basePath %>dingdanservlet?order=shouhuo&dingdanid=${dingdan.dingdanid }" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">确定收货</font></a></td>
					</c:if>
					<c:if test="${dingdan.effective==4}">
						<td colspan="2">待评价</td>
						<td align="right"><a href="<%=basePath %>pingjiaservlet?order=init&homeid=${dingdan.homeid }" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">立即评价</font></a></td>
					</c:if>
					<c:if test="${dingdan.effective==5}">
						<td colspan="2">已评价</td>
						<td align="right"><a href="<%=basePath %>pingjiaservlet?order=look&dingdanid=${dingdan.dingdanid }" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">查看评价</font></a></td>
					</c:if>
				</tr>
			</table>
		</div>
		...
		<div class="body" id="JS_edit_address_edit">
			<div class="address_box" id="JS_address_list_box">
					<div id="JS_address_list_1580151" class="list" onmouseover="M.addClass(this,&#39;hover&#39;);" onmouseout="M.removeClass(this,&#39;hover&#39;);">
						<label><b>收货人姓名：</b></label>
						<label>
							<span id="JS_address_list_detail_1580151">${address.username }</span>
						</label>
						<br/><br/>
						<label><b>配送区域：</b></label>
						<label>
							<span id="JS_address_list_detail_1580151"> ${address.address }</span>
						</label>
						<br/><br/>
						<label><b>移动电话：</b></label>
						<label>
							<span id="JS_address_list_detail_1580151">${address.telephone }  </span>
						</label>
						<br/><br/>
						<label><b>备用电话：</b></label>
						<label>
							<span id="JS_address_list_detail_1580151">${address.phone }  </span>
						</label>
						<br/><br/>
						<label><b>邮政编码：</b></label>
						<label>
							<span id="JS_address_list_detail_1580151">${address.unicode }  </span>
						</label>
					</div>
			</div>
		...
		<div>
			<table id="JS_cart_table" class="cart_table">
				...
				<tbody id="JS_shop_list_7844" class="shop_list" data-shop_id="7844">
					...
					<td><div class="yen" id="goods_subtotal_27542860">¥<span class="show_price">${home.price -home.discount}</span></div><div class="goods_install_fee goods_install_end" style="display:none;"></div></td>
					...
					<td colspan="8">
						<ul class="count-list">
							<li class="clearfix">
								...
								<div class="col-right"><span id="JS_total_7844" class="total red"><span class="yen">¥</span>${home.price}</span></div>
							</li>
							<li class="clearfix">
								<div class="col-left">
								 <span>配送费用:	</span>
