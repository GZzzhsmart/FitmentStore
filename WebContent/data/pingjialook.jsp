...
<div class="w mt10"><h1 class="fl_h1">用户评价</h1></div>
<div class="pre_box w">
	...
	<div id="JS_address_box__" class="currentBox">
		...
		<div class="body" id="JS_edit_address_edit">
			<div>
				...
				<tbody id="JS_shop_list_7844" class="shop_list" data-shop_id="7844">
					...
					<td style="text-align:left;vertical-align:top" valign="top">
						...
						<p class="gray">编号：L JJ-${dingdan.homeid }</p>																		
					</td>
					<td class="yen"> <span class="goods_number">${dingdan.shuliang }</span> 个 </td>
					<td class="yen">¥${dingdan.money }</td>
					<td><div class="yen" id="goods_subtotal_27542860">¥<span class="show_price">${dingdan.price}</span></div><div class="goods_install_fee goods_install_end" style="display:none;"></div></td>
			...
			<div class="address_box" id="JS_address_list_box">
				...
				<div>
					<span><font size="4">评价等级:</font></span>&nbsp;&nbsp;&nbsp;&nbsp;
					<c:if test="${pingjia.evallevel==1}">
						<input type="text" readonly="readonly" value="满意" style="width:100px;height:30px;text-align: center; font-size:22px;border:1px" size="40">
					</c:if>
					<c:if test="${pingjia.evallevel==2}">
						<input type="text" readonly="readonly" value="一般" style="width:100px;height:30px;text-align: center; font-size:22px;border:1px" size="40">
					</c:if>
					<c:if test="${pingjia.evallevel==3}">
						<input type="text" readonly="readonly" value="不满意" style="width:100px;height:30px;text-align: center; font-size:22px;border:1px" size="40">
					</c:if>
					
				</div>
				
						<div>
							<span><font size="4">评价图片：</font></span> &nbsp;&nbsp;&nbsp;
						<c:if test="${pingjia.pictureurl1!='attached/jiaju/null'}">
							<img src="<%=basePath %>${pingjia.pictureurl1}"  width="400" height="200">
						</c:if>
					
						<c:if test="${pingjia.pictureurl2!='attached/jiaju/null'}">
							<img src="<%=basePath %>${pingjia.pictureurl2}" width="400" height="200">
						</c:if>
						</div><br/>
						<div>
							<span><font size="4">评价时间：</font></span> &nbsp;&nbsp;&nbsp;
							<input type="text" readonly="readonly" value="${pingjia.evaldate }" style="width:200px;height:30px;text-align: center; font-size:22px;border:1px" size="40">
						</div>
						<div>
							<span><font size="4">评价内容：</font></span> &nbsp;&nbsp;&nbsp;
							<br/>
							<textarea style="width:300px;height:150px" name="evalcontent" id="evalcontent" >${pingjia.evalcontent }</textarea>
						</div><br/>
						
				</div>
				<div>
					<a href="<%=basePath %>pingjiaservlet?order=list2" id="href1" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">返回</font></a>
				</div>
			</div>
