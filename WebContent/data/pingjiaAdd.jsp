...
<script type="text/javascript">
	$(function(){
		$("#href1").bind("click",function(){
			var en=document.getElementById("evalcontent");
			if($("input[name=evallevel]:checked").val()==undefined){
   						alert("请选择评价等级");
						return false;
   				}
   			if(en.value==""){
...
<div class="pre_box w">
	...
	<div id="JS_address_box__" class="currentBox">
		<div class="title clearfix" name="address_box" id="address_box" style="background:#f0f0f0">
			<div class="text Left">用户评价</div>
		</div>
		
		<div class="body" id="JS_edit_address_edit">
			<div class="address_box" id="JS_address_list_box">
				<form action="pingjiaservlet?order=add" method="post" enctype="multipart/form-data" id="form1">
					...
					<div id="JS_address_list_1580151" class="list" onmouseover="M.addClass(this,&#39;hover&#39;);" onmouseout="M.removeClass(this,&#39;hover&#39;);">
						<div>
							...
							<input type="radio" style="width:30px;height:30px" name="evallevel" value="1"/><font size="4">满意</font>&nbsp;&nbsp;&nbsp;
							<input type="radio" style="width:30px;height:30px" name="evallevel" value="2"/><font size="4">一般</font>&nbsp;&nbsp;&nbsp;
							<input type="radio" style="width:30px;height:30px" name="evallevel" value="3"/><font size="4">不满意</font>
						</div><br/>
						
						<div>
							<span><font size="4">评价内容：</font></span> &nbsp;&nbsp;&nbsp;
							<br/>
							<textarea style="width:400px;height:200px" name="evalcontent" id="evalcontent"></textarea>
						</div><br/>
						<div>
							<input type="text" id="shangchuan"  readonly="readonly" value="上传图片" style="width:100px;height:30px;text-align: center; font-size:22px;border:1px" size="40"/>
							<input type="file" value="上传图片" id="file1" name="file1" style="width:400px;height:30px;text-align: center; font-size:22px;border:1px;display:none" size="40"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="file" value="上传图片" id="file2" name="file2" style="width:400px;height:30px;text-align: center; font-size:22px;border:1px;display:none" size="40"/>
						</div><br/>
						<div>
							<a href="javascript:void(0);" id="href1" style="height: 44px; width: 180px; background-color: #ff0033 ;font-size: 25px;"><font color="white">确定</font></a>
						</div>
					</div>
					</form>
				</div>
