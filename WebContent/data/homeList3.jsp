 ...
 <script type="text/javascript">
    		function validate(){
	            ...
	            if(page >${pageBean.totalPage})
	            {
	                ...
	                window.document.location.href = "<%=basePath %>homeservlet?order=findlist&homename=${homename }";
	                return false;
	            }
	              return true;
        	}
...
<div class="category-filter">
	...
	<div class="w">
		...
		<div class="prompt-info">
			<strong class="red f14">&nbsp;${homename }&nbsp;</strong><span>您可根据以下条件进行筛选。</span>
		</div>
				...
				<li style="height:330px;width:275px" class="ga-list g-item" id="${d.homeid+10000}" onmouseover="test(${d.homeid });" onmouseout="test1(${d.homeid });">
					<div class="g-dtl">
						...
						<div class="d-options" id="${d.homeid }" style="display:none">
							<a class="ga5 o-btn o-cart o-btn3" href="javascript:void(0)" onclick="">
								<i class="i3 i"></i><span style="color: #cf000e;"><font size="4">收&nbsp;藏&nbsp;&nbsp;&nbsp;</font></span>
							</a>
							<a class="ga5 o-btn o-cart o-btn3" href="javascript:void(0);" onclick="goodAddToCat(&#39;240487&#39;,this.href,&#39;categoryMainList&#39;);return false;">
...
<br/><br/>
 	...
 	<table align="center" >
        ...
        <c:if test="${pageBean.currentPage != 1}">
            ...
            &nbsp;&nbsp;&nbsp;
            <a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=${pageBean.currentPage - 1 }"><input type="text" readonly="readonly" value="<<上一页" style="width:100px;height:30px;text-align: center; font-size:22px" size="65"/></a>
        </c:if>
        
        <a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }" /><input id="1" type="text" readonly="readonly" value="1" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
        <c:if test="${pageBean.totalPage>3}">
       
	        <c:if test="${pageBean.currentPage == 1}">
	        	
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=2"><input type="text" id="2" readonly="readonly" value="2" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=3"><input type="text" id="3" readonly="readonly" value="3" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	...
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=${pageBean.totalPage }"><input type="text" readonly="readonly" value="${pageBean.totalPage }" style="width:30px;height:30;text-align: center; font-size:22px" size="65"/></a>
	        </c:if>
	        <c:if test="${pageBean.currentPage == 2}">
	        	<c:if test="${pageBean.totalPage>4}">
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=2"><input type="text" readonly="readonly" value="2" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=3"><input type="text" readonly="readonly" value="3" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=4"><input type="text" readonly="readonly" value="4" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	...
	        ...
	        <c:if test="${pageBean.currentPage == 3}">
	        	...
	        	<c:if test="${pageBean.totalPage>5 }">
		        	...
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=3"><input type="text" readonly="readonly" value="3" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=4"><input type="text" readonly="readonly" value="4" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=5"><input type="text" readonly="readonly" value="5" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	...
	        		<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=${pageBean.totalPage }"><input type="text" readonly="readonly" value="${pageBean.totalPage }" style="width:20px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	</c:if>
	        	<c:if test="${pageBean.totalPage<=5}">
	        		<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=2"><input type="text" readonly="readonly" value="2" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=3"><input type="text" readonly="readonly" value="3" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        ...
	        <c:if test="${pageBean.currentPage == 4}">
	        	<c:if test="${pageBean.totalPage>6 }">
		        	...
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=4"><input type="text" readonly="readonly" value="4" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=5"><input type="text" readonly="readonly" value="5" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=6"><input type="text" readonly="readonly" value="6" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	...
	        		<a href="<%=basePath %>homeservlet?order=findlist&page=${pageBean.totalPage }"><input type="text" readonly="readonly" value="${pageBean.totalPage }" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	</c:if>
	        	<c:if test="${pageBean.totalPage<6 }">
	        		<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=2"><input type="text" readonly="readonly" value="2" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
		        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename  }&page=3"><input type="text" readonly="readonly" value="3" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        ...
	        <c:if test="${pageBean.currentPage==pageBean.totalPage-1}">
	         	...
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=${pageBean.currentPage -2 }"><input type="text" readonly="readonly" value="${pageBean.currentPage-2 }" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=${pageBean.currentPage -2 }"><input type="text" readonly="readonly" value="${pageBean.currentPage-1 }" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=${pageBean.currentPage  }"><input type="text" readonly="readonly" value="${pageBean.currentPage }" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        	<a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=${pageBean.currentPage +1 }"><input type="text" readonly="readonly" value="${pageBean.currentPage+1 }" style="width:30px;height:30px;text-align: center; font-size:22px" size="65"/></a>
	        </c:if>
        ...
        <c:if test="${pageBean.currentPage!=pageBean.totalPage}">
            <a href="<%=basePath %>homeservlet?order=findlist&homename=${reuestScope.homename }&page=${ pageBean.currentPage + 1}"><input type="text" readonly="readonly" value="下一页>>" style="width:100px;height:30px;text-align: center; font-size:22px" size="65"/></a>
            &nbsp;&nbsp;&nbsp;
        </c:if>
    	...
    	<form action="homeservlet?order=findlist&homename=${reuestScope.homename }" method="post" onsubmit="return validate();">
            <font size="4">到第</font>
